...
class MockData {
  ...
  static List<Note> _buildNotes() {
    return [
      Note(
        ...
        type: NoteType.free,
        body: 'Kết hợp 4 module: Todo, Note, Habit và Checklist trong cùng 1 app. '
      ...
      Note(
        ...
        body: '- Deep work: làm việc tập trung sâu, không bị ngắt quãng.\n'
        ...
        cornellSummary: 'Deep work là kỹ năng làm việc tập trung sâu để tạo ra giá trị cao. '
  ...
  static List<TemplateItem> _buildTemplateItems() {
    return const [
      TemplateItem(id: 'ti1', templateId: 'tpl1', position: 1, title: 'Uống 1 ly nước', isRequired: true),
      TemplateItem(id: 'ti2', templateId: 'tpl1', position: 2, title: 'Tập 5 phút stretching', isRequired: true),
      TemplateItem(id: 'ti3', templateId: 'tpl1', position: 3, title: 'Viết 3 ưu tiên hôm nay', isRequired: true),
      TemplateItem(id: 'ti4', templateId: 'tpl1', position: 4, title: 'Đọc 5 phút', isRequired: false),
      TemplateItem(id: 'ti5', templateId: 'tpl2', position: 1, title: 'Pull main mới nhất', isRequired: true),
      TemplateItem(id: 'ti6', templateId: 'tpl2', position: 2, title: 'Chạy lint + format', isRequired: true),
      TemplateItem(id: 'ti7', templateId: 'tpl2', position: 3, title: 'Chạy unit test', isRequired: true),
      TemplateItem(id: 'ti8', templateId: 'tpl2', position: 4, title: 'Đọc lại diff lần cuối', isRequired: true),
      TemplateItem(id: 'ti9', templateId: 'tpl2', position: 5, title: 'Viết description PR rõ ràng', isRequired: false),
    ];
  }
  ...
  static List<TemplateItem> itemsForTemplate(String templateId) {
    final items = templateItems.where((i) => i.templateId == templateId).toList();
  ...
  static List<RunItem> _buildRunItems() {
    ...
    return [
      // run1: 2/4 done
      RunItem(id: 'ri1', runId: 'run1', templateItemId: 'ti1', status: RunItemStatus.done, title: 'Uống 1 ly nước', position: 1, completedAt: now.add(const Duration(hours: 7, minutes: 5))),
      RunItem(id: 'ri2', runId: 'run1', templateItemId: 'ti2', status: RunItemStatus.done, title: 'Tập 5 phút stretching', position: 2, completedAt: now.add(const Duration(hours: 7, minutes: 15))),
      RunItem(id: 'ri3', runId: 'run1', templateItemId: 'ti3', status: RunItemStatus.pending, title: 'Viết 3 ưu tiên hôm nay', position: 3),
      RunItem(id: 'ri4', runId: 'run1', templateItemId: 'ti4', status: RunItemStatus.pending, title: 'Đọc 5 phút', isRequired: false, position: 4),
      // run2: hoàn thành
      RunItem(id: 'ri5', runId: 'run2', templateItemId: 'ti5', status: RunItemStatus.done, title: 'Pull main mới nhất', position: 1),
      RunItem(id: 'ri6', runId: 'run2', templateItemId: 'ti6', status: RunItemStatus.done, title: 'Chạy lint + format', position: 2),
      RunItem(id: 'ri7', runId: 'run2', templateItemId: 'ti7', status: RunItemStatus.done, title: 'Chạy unit test', position: 3),
      RunItem(id: 'ri8', runId: 'run2', templateItemId: 'ti8', status: RunItemStatus.done, title: 'Đọc lại diff lần cuối', position: 4),
      RunItem(id: 'ri9', runId: 'run2', templateItemId: 'ti9', status: RunItemStatus.skipped, title: 'Viết description PR rõ ràng', isRequired: false, position: 5),
    ];
  }
  ...
  static DashboardSnapshot dashboardToday() {
    final todayTodos = todos.where((t) =>
        ...
        _isSameDay(t.scheduledDate!, today())).toList();

    int q1 = 0, q2 = 0, q3 = 0, q4 = 0, un = 0;
    for (final t in todayTodos) {
      if (t.isImportant == null || t.isUrgent == null) {
        un++;
    ...
    return DashboardSnapshot(
      score: 42,
      eisenhowerCounts: {'q1': q1, 'q2': q2, 'q3': q3, 'q4': q4, 'un': un},
      habitsToday: 3,
      habitsCompleted: 1,
      frog: todoById('todo1'),
    );
